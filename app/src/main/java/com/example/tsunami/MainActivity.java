    ...
    private class TsunamiAsyncTask extends AsyncTask<URL, Void, Event> {
        ...
        private String makeHttpRequest(URL url) throws IOException {
            ...
            try {
                ...
                // If the response was successful (response code 200),
                // then read the input response and parse the response.
                ...
                Log.e(LOG_TAG , "Url Connection exception caught!" , e);
            } finally {
